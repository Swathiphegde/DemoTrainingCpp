...
void createObject(Emloyee *arr1[3], Project *arr2[3])
{
    ...
    arr1[0]=new Emloyee("e101","swathi",6565.7f,Departent::DEVELOPMENT,new Project("ADAS",12,83838.99f));
    arr1[1]=new Emloyee("e102","Amit",6885.7f,Departent::TESTING,new Project("KAP",45,67776.7f));
    arr1[2]=new Emloyee("e103","Smith",4565.7f,Departent::INTEGRATION,new Project("CAP",56,9898.6f));
